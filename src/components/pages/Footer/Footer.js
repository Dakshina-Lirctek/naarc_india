    ...
    return (
      <div>
        ...
        >
          <div class="container text-center text-md-left mt-5">
            <div class="row mt-3">
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                />
                <p>
                  <i class="fas fa-home mr-8"></i> Komarapalayam, TN, India
                </p>
                <p>
                  <i class="fas fa-envelope mr-8"></i> info.naarctrust@gmail.com
                </p>
                <p>
                  <i class="fas fa-phone mr-8"></i> + 01 234 567 88
                </p>
                <p>
                  <i class="fas fa-print mr-6"></i> + 01 234 567 89
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            style={{ color: "white", background: "#2e3440" }}
